...
<fieldset>
    ...
    <br>
    Contact No.:-<input type="number" name="cno." placeholder="Enter your Contact no." required>
    <br>
    SMS No.:-<input type="number" name="sms" placeholder="Enter your sms no." required>
    <br>
    Recur for next:-<br>
...
<label for="op4"> 2 days</label><br>
   ...
   <button>Log out</button>
    ...
    <link rel="stylesheet" href="log out.php">
</fieldset>
